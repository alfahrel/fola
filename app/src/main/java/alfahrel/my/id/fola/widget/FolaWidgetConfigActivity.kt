...
class FolaWidgetConfigActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.widget_fola_config)
        ...
        btnSave.setOnClickListener {
            ...
            FolaWidgetProvider.updateWidget(this, AppWidgetManager.getInstance(this), appWidgetId)
